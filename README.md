...
<h1 align="center"><strong>LimboAuth</strong></h1>
...
- Supports [H2](https://www.h2database.com/html/main.html), [MySQL](https://www.mysql.com/about/), [PostgreSQL](https://www.postgresql.org/about/) databases;
...
- Uses [BCrypt](https://en.wikipedia.org/wiki/Bcrypt) - the best hashing algorithm for password;
...
- Ability to set [UUID](https://minecraft.fandom.com/wiki/Universally_unique_identifier) from database;
