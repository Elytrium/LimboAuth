...
public class DaoUtils {
    ...
    public static <T, ID> void callBatchTasks(Dao<T, ID> dao, Callable<Void> callable, Callable<Void> success) {
        try {
    ...
    public static <T, ID> long count(Dao<T, ID> dao, PreparedQuery<T> preparedQuery) {
        try {
    ...
    public static <T, ID> PreparedQuery<T> getWhereQuery(Dao<T, ID> dao, String field, Object value) {
        try {
    ...
    public static <T, ID> T queryForFieldSilent(Dao<T, ID> dao, String field, Object value) {
        try {
    ...
    public static <T, ID> T queryForIdSilent(Dao<T, ID> dao, ID id) {
        try {
    ...
    public static <T, ID> T createSilent(Dao<T, ID> dao, T entity) {
        try {
    ...
    public static <T, ID> int updateSilent(Dao<T, ID> dao, T entity, boolean rethrow) {
        try {
            return dao.update(entity);
        } catch (Exception exception) {
            if(rethrow) throw new SQLRuntimeException(exception);
    ...
    public static <T, ID> int deleteSilent(Dao<T, ID> dao, T entity) {
        try {
