...
class _RebuildNewTopicFlag
{
	...
	public function preQueueData( $data )
	{
		try
		{
			...
			$data['realCount'] = \IPS\Db::i()->select( 'COUNT(*)', 'forums_topics' )->first();
		}
		catch( \Exception $e )
		{
	...
	{
		return array( 'text' =>  \IPS\Member::loggedIn()->language()->addToStack('queue_rebuilding_new_topic_flag'), 'complete' => $data['realCount'] ? ( round( 100 / $data['realCount'] * $data['completed'], 2 ) ) : 100 );
	}	
}