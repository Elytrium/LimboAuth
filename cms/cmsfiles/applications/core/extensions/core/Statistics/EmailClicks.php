 ...
 */
class _EmailClicks extends \IPS\core\Statistics\Chart
{
	/**
	 * @brief	Controller
	 */
	public $controller = 'core_activitystats_emailstats_clicks';
	...
	public function getChart( \IPS\Http\Url $url ): \IPS\Helpers\Chart
	{
		...
		$chart->title = \IPS\Member::loggedIn()->language()->addToStack('stats_emailstats_clicks');
